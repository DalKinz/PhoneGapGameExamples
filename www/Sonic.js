(function (window) {
    function Monster(monsterName, x_end) {
        this.initialize(monsterName, x_end);
    }
    ...
    Monster.prototype.initialize = function (monsterName, x_end) {
        var localSpriteSheet = new createjs.SpriteSheet({
            images: ["resources/images/spritesheets/sonic.png"],
        ...
        this.gotoAndPlay("run_h");     //animate
